...
If needed:
- git log --oneline -- <lab-folder>

Repository evidence overrides remembered conversation position if they conflict.

When working with common filenames such as index.html, style.css, or README.md, always identify the lab folder together with the filename to avoid mixing files from different labs.
